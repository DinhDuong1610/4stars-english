package com.fourstars.fourstars_english.screens.auth
...
fun RegisterScreenPreview() {
    ...
    RegisterScreen(navController = rememberNavController(), authRepo = fakeAuthRepo, googleAuthRepo = GoogleAuthRepository(
